...
class DiceLoss(nn.Module):
    def __init__(
      ...
      smooth: float = 1e-7,
        ...
        :param include_background: whether consider background as the first class. Default: True.
        :param sigmoid: whether apply sigmoid function. Default: False.
        :param softmax: whether applying softmax function. Default: True.
        :param reduction: the reduction method. Default: 'mean'
        :param squared_pred: whether using squared prediction at the denominator. Default: True.
        :param smooth: smooth value to avoid divided by zero. Default: 1e-5.
        """
    ...
    def forward(self, inputs: torch.Tensor, targets: torch.Tensor) -> torch.Tensor:
        ...
        :param inputs: The prediction tensor
        :param targets: The ground-truth tensor
...
class DiceCELoss(nn.Module):
    def __init__(
      ...
      lambda_ce: float = 1.
        ...
        :param reduction: the reduction method. Default: 'mean'
        :param smooth: smooth value to avoid divided by zero. Default: 1e-5.
        :param lambda_dice: weighted value for DiceLoss. Default: 1.
        :param lambda_ce: weighted value for CrossEntropyLoss. Default: 1.
        """
        super().__init__()
