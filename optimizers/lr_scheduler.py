...
class LinearWarmupCosineAnnealingLR(LRScheduler):
    def __init__(
      ...
      last_epoch: int = -1,
        ...
        """Simple Implementation of Cosine Annealing Learning Rate Scheduler with Linear Warmups Iterations

        :param optimizer: wrapped optimizer.
        :param warmup_epochs: maximum number of iterations for linear warmup
        :param max_epochs: maximum number of iteration
    ...
    def get_lr(self) -> List[float]:
        """ Compute learning rate using a chainable form of the scheduler """
